...
void Direct3D_Render(HWND hwnd)
{
	...
	formatRect.top = 100;			// 在纵左边为100处写文字
	g_pFont->DrawText(0, _T("【致我们永不熄灭的游戏开发梦想】"), -1, &formatRect, DT_CENTER, D3DCOLOR_XRGB(68, 139, 256));
	formatRect.top = 250;			// 在纵左边为250处写文字
	g_pFont->DrawText(0, _T("游戏开发的世界，我们来降服你了~！"), -1, &formatRect, DT_CENTER, D3DCOLOR_XRGB(255, 255, 255));

	formatRect.top = 400;			// 在纵左边为250处写文字
	g_pFont->DrawText(0, _T("闪闪惹人爱"), -1, &formatRect, DT_CENTER, D3DCOLOR_XRGB(rand() % 256, rand() % 256, rand() % 256));
